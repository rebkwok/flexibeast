...
#         mommy.make_recipe('flex_bookings.future_EV', _quantity=4)
#         mommy.make_recipe('flex_bookings.past_event', _quantity=4)
#         resp = self._get_response(self.staff_user, 'events')
#         self.assertEquals(len(resp.context_data['events']), 4)
#
#     def test_event_register_list_shows_events_only(self):
#         mommy.make_recipe('flex_bookings.future_EV', _quantity=4)
#         mommy.make_recipe('flex_bookings.future_PC', _quantity=5)
#         resp = self._get_response(self.staff_user, 'events')
#         self.assertEquals(len(resp.context_data['events']), 4)
#
...
#         self.event = mommy.make_recipe('flex_bookings.future_EV')
#         self.booking1 = mommy.make_recipe('flex_bookings.booking', event=self.event)
#         self.booking2 = mommy.make_recipe('flex_bookings.booking', event=self.event)
#
#     def _get_response(
...
#             'flex_bookings.booking', event=self.event, status='OPEN', _quantity=5
#             )
...
#             'flex_bookings.block', block_type=block_type, user=self.user, paid=True
#         )
...
#         event = mommy.make_recipe('flex_bookings.future_PC')
#         bookings = mommy.make_recipe(
#             'flex_bookings.booking', event=event, status='OPEN', _quantity=2
#         )
#
...
#         mommy.make('flex_bookings.booking', event=self.event, status='CANCELLED')
...
#         mommy.make_recipe('flex_bookings.booking', event=self.event, _quantity=12)
#         resp = self._get_response(
#             self.staff_user, self.event.slug,
#             status_choice='OPEN'
#         )
...
#         self.event = mommy.make_recipe('flex_bookings.future_EV', cost=7)
#
#     def _get_response(self, user, ev_type, url=None):
#         if not url:
...
#         classes = mommy.make_recipe('flex_bookings.future_PC')
#         resp = self._get_response(self.staff_user, ev_type='events')
...
#         self.event_type_OE = mommy.make_recipe('flex_bookings.event_type_OE')
#         self.event_type_PC = mommy.make_recipe('flex_bookings.event_type_PC')
#
#     def _get_response(self, user, ev_type, url=None):
#         if url is None:
...
#         self.session = mommy.make_recipe('flex_bookings.mon_session', cost=10)
#
...
#         mommy.make_recipe('flex_bookings.tue_session', _quantity=2)
#         mommy.make_recipe('flex_bookings.wed_session', _quantity=2)
...
#
#     def form_data(self, extra_data={}):
#         ev_type = mommy.make_recipe('flex_bookings.event_type_PC')
#         data = {
#             'name': 'test_event',
...
#         )
#         mommy.make_recipe('flex_bookings.mon_session', _quantity=5)
#         self.assertEqual(Event.objects.count(), 0)
#         form_data = {
...
#             'flex_bookings.block', _quantity=3, paid=True
#         )
#         unpaid_blocks = mommy.make_recipe(
#             'flex_bookings.block', paid=False, _quantity=3
#         )
#         current_blocks = active_blocks + unpaid_blocks
#         full_block = mommy.make_recipe(
#             'flex_bookings.block', paid=False, block_type__size=1
#         )
#         mommy.make_recipe('flex_bookings.booking', block=full_block)
#
#         resp = self._get_response(self.staff_user)
#         self.assertEqual(
...
#             mommy.make_recipe('flex_bookings.booking', block=block)
#
#         # all blocks
#         resp = self._get_response(
...
#             'flex_bookings.booking', user=self.user, paid=True,
...
#         )
#         mommy.make_recipe(
#             'flex_bookings.booking', paid=True,
#             payment_confirmed=True, event__date=timezone.now()+timedelta(3),
#             _quantity=2
#         )
#
...
#         )
#         block = mommy.make_recipe(
#             'flex_bookings.block', block_type__event_type=booking.event.event_type,
#             user=self.user
#         )
...
#         event1 = mommy.make_recipe('flex_bookings.future_EV')
#         block1 = mommy.make_recipe(
#             'flex_bookings.block', block_type__event_type=event1.event_type,
#             user=self.user
#         )
#
#         form_data = self.formset_data(
...
#         event1 = mommy.make_recipe('flex_bookings.future_EV')
#         event2 = mommy.make_recipe('flex_bookings.future_EV')
#
#         block1 = mommy.make_recipe(
#             'flex_bookings.block', block_type__event_type=event1.event_type,
#             user=self.user
...
#             'flex_bookings.block', block_type__event_type=event2.event_type,
#             user=self.user
#         )
#         self.assertEqual(Booking.objects.count(), 10)
#         form_data = self.formset_data(
...
#         event = mommy.make_recipe('flex_bookings.future_EV', event_type=event_type)
#         event1 = mommy.make_recipe('flex_bookings.future_EV', event_type=event_type)
#         block = mommy.make_recipe(
#             'flex_bookings.block', block_type__event_type=event_type,
#             block_type__size=1,
#             user=self.user
#         )
#         form_data = self.formset_data(
...
#         event1 = mommy.make_recipe('flex_bookings.future_EV')
#         event2 = mommy.make_recipe('flex_bookings.future_PC')
#
#         block1 = mommy.make_recipe(
#             'flex_bookings.block', block_type__event_type=event1.event_type,
#             user=self.user
...
#         event = mommy.make_recipe('flex_bookings.future_EV', max_participants=2)
...
#         self.block = mommy.make_recipe('flex_bookings.block', user=self.user)
#
...
#             'flex_bookings.block', user=new_user, _quantity=2
#         )
...
#         block_type = mommy.make_recipe('flex_bookings.blocktype')
...
#         """
#         event = mommy.make_recipe('flex_bookings.future_PC')
#         event1 = mommy.make_recipe('flex_bookings.future_PC')
#
#         event_wl = mommy.make_recipe(
#             'flex_bookings.waiting_list_user', event=event, _quantity=3
#         )
#         mommy.make_recipe(
#             'flex_bookings.waiting_list_user', event=event1, _quantity=3
#         )
#         resp = self._get_response(self.staff_user, event)
#
